...
## Preprocessing:
Frame capturing was done from everone one of the videos such that some number(32) of evenly number of frames were extracted from all the videos. If any video is short, then the number of frames extracted were somewhat lesser than 32.
